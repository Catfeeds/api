...
<body>
    <section class="rank ">
        <div class="record">
            <div class="recordText">
                ...
                <p>您本次游戏得分<span>600</span>,</p>
                <p>历史最高得分<span>600</span>,</p>
                <p>击败了<span>80</span>%的其他健康大厨.</p>
                <p class="space">今天还有<span>2</span>次挑战机会。继续加油！</p>
                <p>点击"我要参加"</p>
                <p>客服节线下活动赢好礼!</p>
    ...
    <section class="food hidden">
        <div class="food_y">
            <form action="">
                <input id="ipu" class="ipu" type="text" placeholder="输入易服务登录手机号码">
                <label for="sub">
