...
<div class="loading">
    ...
    <div class="progress-wrap">
        ...
        <div class="progress-bar">
            ...
            <p class="text">loading...<span>76</span>%</p>
        </div>
    </div>
</div>
<canvas id="canvas"></canvas>
<div class="videos" style="display: none;">
    <video src="https://h5-touch.oss-cn-shanghai.aliyuncs.com/ciie/1.mp4" controls id="video1"></video>
    <video src="https://h5-touch.oss-cn-shanghai.aliyuncs.com/ciie/2.mp4" controls id="video2"></video>
    <video src="https://h5-touch.oss-cn-shanghai.aliyuncs.com/ciie/3.mp4" controls id="video3"></video>
</div>
