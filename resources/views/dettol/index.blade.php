...
<head>
    ...
    link
    rel = "stylesheet"
    href = "{{ asset('res/dettol/css/normalize.css') }}" >
        < link
    rel = "stylesheet"
    href = "{{ asset('res/dettol/css/animate.css') }}" >
        < link
    rel = "stylesheet"
    href = "{{ asset('res/dettol/css/style.css') }}" >
        < /head>

        < body >
        < audio
    id = "bgmusic"
    src = "{{ asset('res/dettol/resource/sound/bgmusic.mp3') }}"
    loop = "loop" > < /audio>
        < audio
    id = "effect"
    src = "{{ asset('res/dettol/resource/sound/conglin.mp3') }}" > < /audio>
        < div
    ...
    class
    = "logo"
    src = "{{ asset('res/dettol/resource/ui/other/logo.png') }}" >
        < img
    class
    = "qrCode"
    src = "{{ asset('res/dettol/resource/ui/other/qr_code.png') }}" >
        < img
    class
    = "center"
    src = "{{ asset('res/dettol/resource/ui/other/space_center.png') }}" >
        < div
    class
    = "title" >
        < p >
    ...
    = "textN" > 第M78号行星观测员 < /p>
        ...
        < div
    class
    = "desc" > 地球已经装不下你的好奇心了，给你一艘飞船，宇宙可能都已经被你探索了一遍
    ! < /div>
    < /section>
    < section
    class
    ...
    class
    = "copy"
    data - clipboard - text = "【Dettol滴露官方...】，復·制这段描述€3Uy4b1qHBr7€后咑閞淘♂寳♀" > < /button>
        < /div>
        < img
    class
    = "next"
    src = "{{ asset('res/dettol/resource/ui/other/next.png') }}" >
        < /div>
        < img
    class
    = "box"
    src = "{{ asset('res/dettol/resource/ui/other/box.png') }}" >
        < /section>
        < section
    class
    = "lastImgBox hide" > < /section>
        < div
    class
    = "saveTips hide" > 长按保存图片 < /div>
