...
<body>
    <section>
        <div class="video1">
            <img src="{{ asset('alibaba/bm/images/01.png') }}" id="img1">
            <video 
                id="video1"
                controls
                preload="auto" 
                src="http://wqs.jd.com/promote/superfestival/superfestival.mp4"
                >
            </video>
        </div>
        <div class="video2">
            <img src="{{ asset('alibaba/bm/images/02.png') }}" id="img2">
            <video
                id="video2"
                controls
                preload="auto" 
