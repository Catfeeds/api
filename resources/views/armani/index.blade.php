...
<script type="application/javascript">
    ...
    function email(email) {
        $.get(`{{ url('api/armani/email') }}?email=${email}&path=${ encodeURIComponent('{{ $path }}')}`).success(function () {
            alert('发送成功！')
        })
    }
    console.log(`{{ url('api/armani/email') }}?email=${email}&path=${ encodeURIComponent('{{ $path }}')}`);
</script>
